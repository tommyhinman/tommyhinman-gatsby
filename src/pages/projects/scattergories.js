  ...
  */
  ...
  if (typeof window !== `undefined`) {
    if (window.location.search.length <= 1) {
      console.log(
        "Empty query params -- generating a new random game string and reloading."
      )
            ...
            <div className="column is-5">
              ...
              <div className="columns is-variable is-1 is-mobile">
                <div className="column is-half">
                  <button
                    className="button is-fullwidth is-light is-info"
                ...
                <div className="column is-half">
                  <button
                    className="button is-fullwidth is-light is-success"
                    onClick={newGame}
                  >
                    New Game
                  </button>
